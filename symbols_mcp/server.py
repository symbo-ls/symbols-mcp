...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "and `window.addEventListener` for genuine browser events (`resize`, `beforeunload`, `hashchange`, "
        "`storage`) bound in `onInit` with cleanup stored on `el.scope` and removed in `onRemove`. Anything "
