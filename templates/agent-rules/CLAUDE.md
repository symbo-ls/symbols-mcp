...
This is a Symbols.app / DOMQL v4 project. The `symbols-mcp` MCP server is the source of truth for framework rules, syntax, design system, audit playbook, generation prompts, and platform tools.
